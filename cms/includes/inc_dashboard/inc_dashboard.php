...
function do_main(){
    ...
    $last_user_view = '';
    if(isset($_COOKIE['lastLoggedinUserId']))
    {


        $lastUser = $_COOKIE['lastLoggedinUserId'];
        $lastUserFullName = $_COOKIE['lastLoggedinName'];
            ...
            <div class="dashboard-item">
                ...
                <div class="row">
                    <div class="col-xs-12 ditem-body" style="min-height:117px;">
                        <p class="label-pair"><strong>Username:</strong> {$lastUserFullName}</p>
                        <p class="label-pair"><strong>Date:</strong> {$lastLoginDate->format('d F Y')}</p>
                        <p class="label-pair"><strong>Time:</strong> {$lastLoginDate->format('h:i A')}</p>
                        <p class="label-pair"><strong><a href="$htmladmin/index.php?do=users&action=edit&id={$lastUser}">View profile</a></strong></p>
                    </div>
                </div>
            </div>
        </div>
