    ...
    $settings_content = <<< HTML
        <table width="100%" border="0" cellspacing="0" cellpadding="6">
           ...
           <tr>
            ...
            <tr>
                <td width="130"><label for="page_photo_caption">Page Photo Caption:</label></td>
...
HTML;
    ...
    <table width="100%" cellpadding="6" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td valign="top">
                <textarea maxlength="200" name="short_description" id="short_description" class="check-max" maxlength="200" style="width:730px;height:100px;">$short_description</textarea>
