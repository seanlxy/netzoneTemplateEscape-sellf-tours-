...
if($company_logo_path){
  $company_logo_full_path = $rootfull.$company_logo_path;
  list($width, $height, $type, $attr) = getimagesize($company_logo_full_path);
}else{
  $width='0';
  $height='0';
}
...
$companyLogoView = <<< H
    <table class="company-logo-input">
        <tr>
            ...
            <span class="text-muted"><small>Suggested size: 180x130px</small></span><br>
            <span class="text-muted"><small>Current Logo size: $width x $height</small></span><br>
...
if (mysql_num_rows($colorPalettesSql)) {
    ...
    while ($arrPalettes = mysql_fetch_assoc($colorPalettesSql)) {
        ...
        $palettesContent .= '<label for="'.$arrPalettes['color_palette_name'].'">'
            ...
            . '<span>'
                . '<img src="'.ADMIN_BASE_URL.$arrPalettes['color_palette_cms_preview_thumb_path'].'" alt="'
                . $arrPalettes['color_palette_name'].'"style="width: 112px;">'
            . '</span>'
        .'</label>';
...
##------------------------------------------------------------------------------------------------------
    ...
    <table class="slideshow-input">
        ...
        <tr>
            <td><input name="slideshow_speed" type="text" value="$slideshow_speed" style="width:150px;margin-top: 5px;" id="slideshow_speed" value="5"/>  <strong>seconds</strong></td>
        </tr>
    </table>
HTML;
...
H;
    ...
    $parterLogoView = <<< H
        ...
        <p class="text-muted"><small>Suggested size: 180x130px</small></p>
