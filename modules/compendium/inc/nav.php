...
foreach ($all_sections as $section) {
	...
	if((($section['is_generic']==1)&&($section['default_content']!=''))||(($section['is_generic']!=1)&&($section['content']!=''))){
			...
			$nav_links_static .= '<li'.$map_class.'><i class="'.$section['icon'].'"></i><a class="nav-item" href="#'.$section['hash_key'].'" title="'.$section['heading'].'">'.$section['heading'].' </a></li>';
	}else if ($section['is_map'] == '1'){
		$nav_links .= '<li'.$map_class.'><div class="icon-wrap"><i class="'.$section['icon'].'"></i></div><a href="#'.$section['hash_key'].'" title="'.$section['heading'].'">'.$section['heading'].' </a></li>';
