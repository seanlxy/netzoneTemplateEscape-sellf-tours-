...
if( !empty($gallery_ids) )
{
	...
	if( !empty($gallery_photos) )
    {
        ...
        $gallery_list_view .= '<div class="container "><div class="row"><div class="col-xs-12 mob-gallery"><div class="galleries" id="shuffle">';
        $count=0;
        ...
        foreach ($gallery_photos as $photo)
        {
            ...
            if($count == 0){
                ...
                $gallery_list_view .= '<figure class="col-xs-12 col-sm-3 first-img col-md-3 img ps-item" data-groups="[&#34;all&#34;,&#34;'.$photo['group_key'].'&#34;]" data-fpath="'.$photo['full_path'].'" data-size="'.$photo['size'].'" data-gp="'.$photo['group_key'].'" title="'.$photo['caption'].'">
                            <span'.$img.'></span>
                        </figure>';

            } else{
                $gallery_list_view .= '<figure class="col-xs-12 col-sm-3 other-img col-md-3 img ps-item" data-groups="[&#34;all&#34;,&#34;'.$photo['group_key'].'&#34;]" data-fpath="'.$photo['full_path'].'" data-size="'.$photo['size'].'" data-gp="'.$photo['group_key'].'" title="'.$photo['caption'].'">
                            <span'.$img.'></span>
                        </figure>';
            }
          $count++;
